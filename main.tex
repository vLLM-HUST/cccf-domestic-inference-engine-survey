...
\newcommand{\authorscn}{张书豪$^{1}$，刘世峰$^{1}$，杜雨枫$^{1}$，马俊豪$^{1}$，邱瑞杰$^{1}$，廖小飞$^{1}$，金海$^{1}$}
\newcommand{\authorsen}{Shuhao Zhang$^{1}$, Shifeng Liu$^{1}$, Yufeng Du$^{1}$, Junhao Ma$^{1}$, Ruijie Qiu$^{1}$, Xiaofei Liao$^{1}$, Hai Jin$^{1}$}
