...
\node[draw=black!60, rounded corners=2.2pt, fill=white, inner sep=4pt, align=center, font=\scriptsize, below=21mm of core, minimum width=58mm] (outcome) {路线比较 \quad $\rightarrow$ \quad 回归验证 \quad $\rightarrow$ \quad 交付诊断};
